              ...
              <div className="listItem">
                ...
                <div className='listOptions'>
                  <div className="listOptionItem">
                    ...
                    <input type="number" className='listOptionInput' onChange={ e => setMin(e.target.value)}></input>
                  </div>
                  <div className="listOptionItem">
                    <span className="listOptionText"> 
                      Max price <small>per night</small>
                    </span>
                    <input type="number" className='listOptionInput' onChange={ e => setMax(e.target.value)}></input>
                  </div>
                  <div className="listOptionItem">
                    <span className="listOptionText"> 
                      Adults
